...
class Order(PermanentModel, models.Model):
    ...
    appretail_opportunity_no = models.CharField(max_length=255,null=True, blank=True)
...
class OrderNote(models.Model):
    ...
    note_date=models.CharField(max_length=100,null=True)
    note_status = models.CharField(max_length=100,null=True)
