...
function CalendarControl() {
    ...
    function calendarDrawTable() {
        ...
        table = table + "<tr class='cl_header'><th colspan='3' style='padding: 0px;'><a href='javascript:;' onclick='javascript:clearCalendarControl();'>Clear</a> | <a href='javascript:;' onclick='javascript:hideCalendarControl();'>Close</a></td></tr>";
        table = table + "</table>";
        return table;
    }
    this.show = show;
    ...
    function show(field, xp, yp) {
        can_hide = 0;
        if (dateField == field) { return; } else { dateField = field; }
        if (dateField) {
            try {
